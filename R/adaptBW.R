...
#' adaptBW21$plt # plot
#' adaptBW22$plt # plot
adaptBW = function(residuals, station, start_ind, end_ind, type, seasonal_coefs) {
  ...
  for (i in 1:p) {
    ...
    initial = c(3.5, 0.5, 0.5, -0.5, -0.2, 0.2, 0.1, -0.1, rep(0, 57)) # initialise parameter values
    lower_bound = rep(-50, 65) # lower bounds for the 33 parameters
    upper_bound = rep(50, 65) # upper bounds for the 33 parameters
